function addUI() {
	...
	+'<img class="manImg" src='+$.img()+'/kakao.png ></img></a>'
	...
	+'                        <div class="input-group">'
	                            +'<input type="text" style="width:45%" size="7" class="form-control signup-form__email__email-username" id="signup-form__email__email-username" name="signup-email-username" autofocus="" autocomplete="off">'
	+'                            <span class="form-separator signup-form__email__email-at-mark">@&nbsp</span>'
	...
	+'                        <p class="je_p1">8자이상 영문 대 소문자, 숫자, 특수문자를 사용하세요.</p>'
